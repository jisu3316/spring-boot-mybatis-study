...
<div class="container">
    ...
    <form id="board-form">
        ...
        <div class="row mb-3 justify-content-md-center">
            ...
            <div class="col-sm-8 col-lg-9">
                <textarea class="form-control" id="boardContent" name="boardContent" rows="5" value="" required>${board.boardContent}</textarea>
            </div>
        </div>
        <div class="row mb-4 justify-content-md-center">
            <label for="boardUserName" class="col-sm-2 col-lg-1 col-form-label text-sm-end">작성자</label>
            <div class="col-sm-8 col-lg-9">
                <input type="text" class="form-control" id="boardUserName" name="boardUserName" value="${board.boardUserName}" readonly>
            </div>
        </div>
        <div class="row mb-4 justify-content-md-center">
        ...
        <div class="row mb-5 justify-content-md-center">
            <div class="col-sm-10 d-grid gap-2 d-sm-flex justify-content-sm-end">
                <button type="button" class="btn btn-primary" id="submit-button" onclick="updateBoard(${page})">저장</button>
